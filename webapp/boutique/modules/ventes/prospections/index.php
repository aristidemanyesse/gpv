                                    ...
                                    <?php foreach ($encours as $key => $prospection) {
                                        ...
                                        <tr style="border-bottom: 2px solid black">
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <?php if ($employe->isAutoriser("modifier-supprimer") && $prospection->etat_id != Home\ETAT::ANNULEE) { ?>
                                                    <button onclick="annuler('prospection', <?= $prospection->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php  } ?>
