                            ...
                            <tbody>
                               <?php foreach ($encours as $key => $vente) {
                                ...
                                <td>
                                    ...
                                    <?php if ($employe->isAutoriser("modifier-supprimer") && $vente->etat_id != Home\ETAT::ANNULEE) { ?>
                                        <button onclick="annuler('vente', <?= $vente->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php  } ?>
