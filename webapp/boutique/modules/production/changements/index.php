    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-9">
                    <h2 class="text-uppercase text-blue gras">Les changements et retours de stock en boutique</h2>
                    <div class="container">
                    </div>
                </div>
                <div class="col-sm-3 text-right">
                    <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-retourstockboutique' class="btn btn-primary btn-sm dim float-right"><i class="fa fa-plus"></i> Nouveau changement/retour </button>
                </div>
            </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Tous les retours de stock survenues dans cet boutique</h5>
...
<div class="modal inmodal fade" id="modal-retourstockboutique">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form method="POST" class="formShamman" classname="retourstockboutique">
