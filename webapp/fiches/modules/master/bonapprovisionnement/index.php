                            ...
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 text-right">
                                        <h2 class="title text-uppercase gras text-blue">Bon d'approvisionnement</h2>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($appro->ligneapprovisionnements as $key => $ligne) {
                                            ...
                                            <tr>
                                                <td class="desc">
                                                    <h5 class="mp0 text-uppercase gras"><?= $ligne->ressource->name() ?></h5>
                                                </td>
                                                <td></td>
                                                ...
                                                <td class="text-center">
                                                    <h3 class="gras mp0"> <small>x</small> <?= start0($ligne->quantite) ?> <?= $ligne->ressource->abbr  ?></h3>
                                                </td>
