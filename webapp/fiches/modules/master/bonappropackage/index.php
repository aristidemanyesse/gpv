                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($appro->ligneappropackages as $key => $ligne) {
                                            $ligne->actualise(); ?>
                                            <tr>
                                                <td><img style="height: 25px" src="<?= $this->stockage("images", "emballages", $ligne->package->image)  ?>" alt="placeholder+image"></td>
                                                <td class="desc">
                                                    <h5 class="mp0 text-uppercase gras"><?= $ligne->package->name() ?></h5>
                                                </td>
                                        ...
                                        <tr class="border">
                                            <td colspan="3" class="text-uppercase text-right"><h4 class=" text-<?= ($appro->reste > 0) ? "warning":"muted"  ?> ">reste à payer pour cette commande = </h4></td>
                                            <td></td>
