$(function(){
    ...
    $(".newressource").click(function(event) {
        var url = "../../webapp/entrepot/modules/stock/appropackage/ajax.php";
    ...
    calcul = function(){
        ...
        $("#modal-appropackage .approvisionnement tr, #modal-appropackage_ .approvisionnement tr").each(function(index, el) {
            var id = $(this).attr('data-id');
        ...
        $.post({url:url, data:formdata, contentType:false, processData:false}, function(data){
            $("#modal-appropackage tbody.approvisionnement, #modal-appropackage_ tbody.approvisionnement").html(data);
    ...
    terminer = function(id){
        alerty.confirm("Cet approvisionnement est-il vraiment terminé ?", {
            ...
            session("appropackage_id", id);
            modal("#modal-appropackage"+id);
        })
    }
