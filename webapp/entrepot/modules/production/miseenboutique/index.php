    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-3">
                <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-miseenboutique' class="btn btn-primary btn-sm dim float-right"><i class="fa fa-plus"></i> Nouvelle mise en boutique </button>
            </div>
        </div>
                         ...
                         <?php foreach ($encours as $key => $mise) {
                            ...
                            <tr style="border-bottom: 2px solid black">
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <?php if ($employe->isAutoriser("modifier-supprimer") && $mise->etat_id != Home\ETAT::ANNULEE) { ?>
                                        <button onclick="annuler('miseenboutique', <?= $mise->id ?>)" class="btn btn-white btn-sm"><i class="fa fa-trash text-red"></i></button>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php  } ?>
