...
<div class="modal inmodal fade" id="modal-appropackage" style="z-index: 99999999">
    <div class="modal-dialog modal-xl" style="width: 95%">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Nouvel approvisionnement d'extras d'emballage</h4>
                    ...
                    <div class="ibox-content"><br>
                        <div class="table-responsive">
                            ...
                            <div class=" text-center">
                                <?php foreach (Home\PACKAGE::getAll() as $key => $item) {
                                    $item->actualise();
                                    if ($item->isActive()) { ?>
                ...
                <div class="ibox"  style="background-color: #eee">
                    ...
                    <div class="ibox-content container-fluid"  style="background-color: #fafafa">
                        <form id="formApprovisionnement" >
                            ...
                            <input type="hidden" name="typeapprovisionnement_id" value="<?= Home\TYPEAPPROVISIONNEMENT::PACKAGE ?>">
                        </form>
                        <hr/>
