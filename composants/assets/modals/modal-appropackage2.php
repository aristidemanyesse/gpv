...
<div class="modal inmodal fade" id="modal-appropackage<?= $appro->id ?>" style="z-index: 99999999">
                ...
                <div class="col-md-8">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5 class="text-uppercase">Les emballages effectivement reçus</h5>
                        </div>
                                ...
                                <table class="table table-striped">
                                    <tbody class="commande">
                                        <?php foreach ($appro->ligneappropackages as $key => $ligne) {
                                            $ligne->actualise(); ?>
                                            <tr class="border-0 border-bottom " id="ligne<?= $ligne->id ?>" data-id="<?= $ligne->package->id ?>">
                                                <td class="text-left">
                                                    <small>Emballage de </small>
                                                    <h5 class="mp0 text-uppercase"><?= $ligne->package->name() ?></h5>
                                                </td>
                                                <td width="150">
