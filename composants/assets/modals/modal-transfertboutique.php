...
<div class="modal inmodal fade" id="modal-transfertboutique" style="z-index: 9999999999">
                ...
                <div class="col-md-4 ">
                    <div class="ibox"  style="background-color: #eee">
                        ...
                        <div class="ibox-content"  style="background-color: #fafafa">
                            <form id="formTransfertboutique">
                                <div>
                                    <label>Boutique de destination <span style="color: red">*</span> </label>
                                    <div class="input-group">
                                        <?php Native\BINDING::html("select", "boutique", null, "boutique_id_destination"); ?>
                                    </div>
                                </div><br>
                            ...
                            <hr/>
                            <button onclick="transfertboutique()" class="btn btn-primary btn-block dim"><i class="fa fa-check"></i> Valider la sortie</button>
                        </div>
                    </div>
